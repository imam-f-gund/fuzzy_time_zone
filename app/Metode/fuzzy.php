...
class fuzzy
{
    ...
    {
        $dataTerakhir = $data[count($data) - 1];
        $bulan = [
            1 => 'Januari',
            2 => 'Febuari',
            3 => 'Maret',
        ...
        if ($dataTerakhir['index_bulan'] == 12) {
            $bulan_prediksi = 1;
            $tahun_prediksi = $dataTerakhir['tahun'] + 1;
        } else {
            $bulan_prediksi = $dataTerakhir['index_bulan'] + 1;
            $tahun_prediksi = $dataTerakhir['tahun'];
        }

        $data = [
            'bulan' => $bulan[$bulan_prediksi],
            'index_bulan' => $bulan_prediksi,
            'tahun' => $tahun_prediksi,
            'hasil_peramalan' => $dataTerakhir['nilai_flr'],
        ];
